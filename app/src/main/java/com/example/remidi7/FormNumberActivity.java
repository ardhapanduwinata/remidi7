    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String date = "";
                date = myCalendar.toString();

                if(namaRuang.isEmpty() || date.isEmpty())
                {
                    Toast.makeText(FormNumberActivity.this, "Nama ruang atau tanggal masih kosong!", Toast.LENGTH_SHORT).show();
                } else {
